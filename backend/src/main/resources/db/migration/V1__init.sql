CREATE TABLE delivery_project (
 ...
 workspace_path VARCHAR(1000) NOT NULL, planner_session_id VARCHAR(255), created_at TIMESTAMP WITH TIME ZONE NOT NULL, updated_at TIMESTAMP WITH TIME ZONE NOT NULL);
...
CREATE TABLE task_run (
 ...
 findings_json TEXT, started_at TIMESTAMP WITH TIME ZONE NOT NULL, finished_at TIMESTAMP WITH TIME ZONE);
